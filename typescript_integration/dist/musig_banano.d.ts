...
export interface InitOutput {
  ...
  readonly musig_stage0: (a: number, b: number) => number;
  readonly musig_stage1: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => number;
