...
export function musig_stage0(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
export function musig_stage1(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
